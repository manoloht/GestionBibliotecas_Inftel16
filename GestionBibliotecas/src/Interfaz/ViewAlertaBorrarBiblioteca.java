 ...
 */
public class ViewAlertaBorrarBiblioteca extends javax.swing.JFrame {

    /**
     * Creates new form AlertaBorrarBiblioteca
     */
    public String par;
    ViewExitoBorrar vistaExitoBorrar;

    public ViewAlertaBorrarBiblioteca(String par) {
        initComponents();
        this.par = par;
    ...
    private void btnSIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSIActionPerformed
        ...
        System.out.println("----> Borrando Biblioteca: " + this.par);
        if (CTRBiblioteca.borrarBiblioteca(this.par)) {
    ...
    private void btnNOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNOActionPerformed
        // TODO add your handling code here:
        System.out.println("----> Se ha cancelado el borrar biblioteca.");
        this.setVisible(false);
